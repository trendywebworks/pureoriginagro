...
<section class="contact-hero">
    ...
    <div class="micro">Contact SJ Global Boat</div>
...
<section class="contact-main" id="contact-form">
    ...
    <aside class="contact-details reveal">
        ...
        <div><span>Email</span><a href="mailto:info@sjglobalboat.com">info@sjglobalboat.com</a></div>
...
<section class="contact-strip">
    ...
    </div><a class="btn btn-outline" href="mailto:info@sjglobalboat.com">Email us now <b>↗</b></a>
    </div>
</section>
